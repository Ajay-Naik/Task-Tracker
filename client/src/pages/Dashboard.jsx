    ...
    <div style={styles.container}>
      ...
      <div style={styles.stats}>
        ...
        <div
          style={{
            ...styles.stat,
            ...(filter === "in-progress" ? styles.statActive : {}),
          }}
...
const styles = {
  ...
  statActive: { background: "#4f46e5", color: "#fff" },
  tasks: {},
